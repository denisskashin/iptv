...
BLOCKLIST: set[str] = {
    ...
    "viju TV1000 kino",
    "viju TV1000 R Kino",
    "Viju TV1000 Romantica HD",
    "viju TV1000 russkoe",
    "viju TV1000 Новелла HD",
    "Viju TV1000 Новелла",
    "Viju TV1000 Русское HD",
    "viju TV1000 Русское кино HD",
    "viju TV1000 Русское",
    "viju TV1000",
    "viju+ Comedy HD",
    "viju+ Comedy",
    ...
    "World Fashion Channel SD ru",
    "World Fashion Channel SD",
    "World Fashion Channel",
    "World Fashion Channelᴴᴰ",
    "World Fashion",
    "WORLD HD",
    "World of Animals 4K",
    "Wydarzenia 24",
    ...
    "Бигуди ТВ",
    "Бийское ТВ",
    "Блеф 2026 США|Драма|Бойовик|Пригоди|Історичний",
    "Блокбастер HD",
    "Блокбастер",
    "Бобер",
    "Бокс ТВ",
    ...
    "Глас",
    "Горная долина",
    "Город (Курганская область г.Шадринск)",
    "Город 24",
    ...
    "День Победы",
    "Детектив",
    "Детеныши Животных В 4К",
    "Детский Мир HD",
    "Детский мир",
    "Детский телеканал Мультимания",
    "Детское кино INT",
    "Детское кино International",
    "Детское кино",
    "Детское КиноЗал International",
    "Джахоннамо (TJ)",
    "Джунгли",
    "Дзержинск ТВ",
    "Дзержинск",
    ...
    "Живи!",
    "Живи",
    "Животные Австралии В 4К",
    "Жизнь Глазова",
    "За!ТВ",
    "Завораживающие пейзажи мира",
    "Загублений світ+ HD",
    "Закон ТВ",
    "Зал суда",
    ...
    "Золотая коллекция",
    "Зоо",
    "Ивановское общественное телевидение (Иваново)",
    "Ивановское общественное телевидение",
    "Ивановское",
    "Игра судьбы HD",
    "Известия (Старый Оскол)",
    "Известия HD",
    "Известия Город Оренбург",
    "Известия Саратов",
    "Известия ТВ [FHD]",
    "Известия ТВ HD",
    "Известия ТВ",
    ...
    "Катастрофа ONLINE",
    "Катастрофы",
    "Каттегат в 4К С Музыкой Викингов",
    "Катунь 24 (Барнаул)",
    "Катунь 24",
    "Квартал ТВ",
    "Кения В 4К",
    "Керчь 24 (Республика Крым)",
    "Кинеко HD",
    "Кинеко",
    "Кино 1 INT",
    ...
    "Кино ТВ HD",
    "Кино ТВ",
    "Кино- Последний концерт в Лужниках",
    "Кино6",
    "Киножелезо",
    "КиноЗал 1 International",
    "Кинозалы 1",
    "Кинозалы 10",
    "Кинозалы 11",
    "Кинозалы 12",
